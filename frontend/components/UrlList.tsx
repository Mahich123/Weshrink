...
export default async function UrlList() {
    ...
    return (
        <div className="min-h-screen text-white p-4  md:p-16 font-Nunito">
            <div className="max-w-7xl mx-auto space-y-8">
                <div className="flex justify-center items-center relative w-full">
                    <Input
                        className="w-2/6 bg-[#6E6F77] border border-[#F4F4F4] h-12 rounded-xl outline-none text-center text-xl placeholder:text-white placeholder-opacity-100"
