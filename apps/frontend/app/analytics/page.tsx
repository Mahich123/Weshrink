...
export default function Analytics() {
  return (
    <div className='bg-[#1F233B] h-auto'>
      <Header />
      <div className='max-w-7xl 2xl:max-w-[88vw] mx-auto px-4 p-20 grid grid-cols-1 md:grid-cols-10 lg:grid-cols-10 gap-x-4 gap-y-4 text-white items-center justify-center'>
